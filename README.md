# La Petite Villageoise - Restaurant - Plateforme Web E-commerce

Bienvenue sur le dépôt du code source de l'application web **La Petite Villageoise - Restaurant**. Ce projet est une solution complète (Site Vitrine + E-commerce + Administration) développée avec des technologies modernes pour assurer performance et évolutivité.
...
| :--- | :--- | :--- | :--- |
| **Administrateur** | `admin@lapetitevillageoiserestaurant.cm` | `admin123` | **OTP : 2025** |
| **Utilisateur** | `user@lapetitevillageoiserestaurant.cm` | `user123` | |
...
*   **Contact :** contact@lapetitevillageoiserestaurant.cm